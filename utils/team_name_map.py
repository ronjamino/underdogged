...
TEAM_NAME_MAP = {
    ...
    # Odds API names (no "FC" suffix, different formatting)
...
EUROPEAN_TEAM_MAPPINGS = {
    # Bundesliga - Complete mappings
...
# Update your TEAM_NAME_MAP:
TEAM_NAME_MAP.update(EUROPEAN_TEAM_MAPPINGS)
